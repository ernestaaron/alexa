...
---
![Hello World Skill](https://cdn-images-1.medium.com/max/800/1*BzP-MbBpdiNouIdHIL02Cg.png)
...
---
* Open the [Link 1 -- AWS Lambda console](https://console.aws.amazon.com/lambda/home?region=us-east-1#/create?step=2)
...
---
Copy the [Link 2 --- Hello World application source code](https://github.com/ernestaaron/alexa/blob/master/src/index.js)
---
...
---
Open the [Link 3 -- Amazon Developer Skills portal](https://developer.amazon.com/edw/home.html#/skills/list) and login with the same Amazon account that your Alexa device is linked with.
---
